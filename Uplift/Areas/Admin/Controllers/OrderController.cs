...
namespace Uplift.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int id) 
        {
            OrderViewModel orderVM = new OrderViewModel()
            {
                ...
                OrderDetails = _unitOfWork.OrderDetails
                    .GetAll(filter: o => o.OrderHeaderId == id)
            };
            return View(orderVM);
        }
        ...
        public IActionResult GetAllOrders()
        {
            return Json(new
            {
                data = _unitOfWork.OrderHeader.GetAll()
            });
        }
        ...
        public IActionResult GetAllPendingOrders()
        {
            return Json(new
            {
                data = _unitOfWork.OrderHeader.GetAll(filter: o => o.Status == SD.StatusSubmitted)
            });
        }
        ...
        public IActionResult GetAllApprovedOrders()
        {
            return Json(new
            {
                data = _unitOfWork.OrderHeader.GetAll(filter: o => o.Status == SD.StatusApproved)
            });
        }
        #endregion
    }
